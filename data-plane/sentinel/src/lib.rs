...
//! them into a single score, applies policy thresholds, and emits a decision
//! together with the reason codes and the contribution breakdown that justify
//! it.
//!
//! # Non-responsibility
//!
...
pub use policy::{AgentPolicy, SentinelPolicy};
